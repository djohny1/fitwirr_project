...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Exercise.gender'
        db.delete_column(u'exerciselibrary_exercise', 'gender')

        # Adding field 'Exercise.weight'
        db.add_column(u'exerciselibrary_exercise', 'weight',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Exercise.gender'
        raise RuntimeError("Cannot reverse this migration. 'Exercise.gender' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Exercise.gender'
        db.add_column(u'exerciselibrary_exercise', 'gender',
                      self.gf('django.db.models.fields.CharField')(max_length=10),
                      keep_default=False)

        # Deleting field 'Exercise.weight'
        db.delete_column(u'exerciselibrary_exercise', 'weight')
    ...
    models = {
        ...
        u'exerciselibrary.exercise': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'equipments': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True'}),
