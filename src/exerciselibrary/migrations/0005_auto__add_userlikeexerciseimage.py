...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserLikeExerciseImage'
        db.create_table(u'exerciselibrary_userlikeexerciseimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('exercise_image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exerciselibrary.ExerciseImage'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'exerciselibrary', ['UserLikeExerciseImage'])


    def backwards(self, orm):
        # Deleting model 'UserLikeExerciseImage'
        db.delete_table(u'exerciselibrary_userlikeexerciseimage')
