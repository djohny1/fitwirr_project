...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'exerciselibrary_category', 'meta_keywords',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.meta_description'
        db.add_column(u'exerciselibrary_category', 'meta_description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Exercise.meta_keywords'
        db.add_column(u'exerciselibrary_exercise', 'meta_keywords',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Exercise.meta_description'
        db.add_column(u'exerciselibrary_exercise', 'meta_description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'exerciselibrary_category', 'meta_keywords')

        # Deleting field 'Category.meta_description'
        db.delete_column(u'exerciselibrary_category', 'meta_description')

        # Deleting field 'Exercise.meta_keywords'
        db.delete_column(u'exerciselibrary_exercise', 'meta_keywords')

        # Deleting field 'Exercise.meta_description'
        db.delete_column(u'exerciselibrary_exercise', 'meta_description')
