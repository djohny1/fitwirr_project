...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Exercise.exercise_place'
        db.delete_column(u'exerciselibrary_exercise', 'exercise_place')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Exercise.exercise_place'
        raise RuntimeError("Cannot reverse this migration. 'Exercise.exercise_place' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Exercise.exercise_place'
        db.add_column(u'exerciselibrary_exercise', 'exercise_place',
