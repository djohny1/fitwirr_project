...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exercise.equipments'
        db.add_column(u'exerciselibrary_exercise', 'equipments',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'Exercise.reps'
        db.add_column(u'exerciselibrary_exercise', 'reps',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Exercise.sets'
        db.add_column(u'exerciselibrary_exercise', 'sets',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exercise.equipments'
        db.delete_column(u'exerciselibrary_exercise', 'equipments')

        # Deleting field 'Exercise.reps'
        db.delete_column(u'exerciselibrary_exercise', 'reps')

        # Deleting field 'Exercise.sets'
        db.delete_column(u'exerciselibrary_exercise', 'sets')
