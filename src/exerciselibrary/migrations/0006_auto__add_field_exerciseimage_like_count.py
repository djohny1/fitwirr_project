...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExerciseImage.like_count'
        db.add_column(u'exerciselibrary_exerciseimage', 'like_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExerciseImage.like_count'
        db.delete_column(u'exerciselibrary_exerciseimage', 'like_count')
