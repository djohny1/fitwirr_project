...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exercise.weight'
        db.alter_column(u'exerciselibrary_exercise', 'weight', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'Exercise.equipments'
        db.alter_column(u'exerciselibrary_exercise', 'equipments', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):

        # Changing field 'Exercise.weight'
        db.alter_column(u'exerciselibrary_exercise', 'weight', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Exercise.equipments'
        db.alter_column(u'exerciselibrary_exercise', 'equipments', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    ...
    models = {
        ...
        u'exerciselibrary.exercise': {
            ...
            'home_gym': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'meta_description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'meta_keywords': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'muscle': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'reps': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'sets': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
