...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exercise.active'
        db.add_column(u'exerciselibrary_exercise', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exercise.active'
        db.delete_column(u'exerciselibrary_exercise', 'active')
