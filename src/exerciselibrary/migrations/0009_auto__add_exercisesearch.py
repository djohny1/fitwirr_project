...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExerciseSearch'
        db.create_table(u'exerciselibrary_exercisesearch', (
        ...
        db.send_create_signal(u'exerciselibrary', ['ExerciseSearch'])


    def backwards(self, orm):
        # Deleting model 'ExerciseSearch'
        db.delete_table(u'exerciselibrary_exercisesearch')
