...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blog.is_active'
        db.add_column(u'blog_blog', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Category.is_active'
        db.add_column(u'blog_category', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Blog.is_active'
        db.delete_column(u'blog_blog', 'is_active')

        # Deleting field 'Category.is_active'
        db.delete_column(u'blog_category', 'is_active')
