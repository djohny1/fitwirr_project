...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'blog_blog', 'active')

        # Adding field 'Blog.sub_title'
        db.add_column(u'blog_blog', 'sub_title',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Blog.meta_keywords'
        db.add_column(u'blog_blog', 'meta_keywords',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Blog.meta_description'
        db.add_column(u'blog_blog', 'meta_description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'blog_blog', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Blog.sub_title'
        db.delete_column(u'blog_blog', 'sub_title')

        # Deleting field 'Blog.meta_keywords'
        db.delete_column(u'blog_blog', 'meta_keywords')

        # Deleting field 'Blog.meta_description'
        db.delete_column(u'blog_blog', 'meta_description')
