...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'blog_searchterm')

        # Adding model 'BlogSearch'
        db.create_table(u'blog_blogsearch', (
        ...
        db.send_create_signal(u'blog', ['BlogSearch'])


    def backwards(self, orm):
        # Adding model 'SearchTerm'
        db.create_table(u'blog_searchterm', (
            ('q', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('search_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Blog'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
        ...
        db.send_create_signal(u'blog', ['SearchTerm'])

        # Deleting model 'BlogSearch'
        db.delete_table(u'blog_blogsearch')
